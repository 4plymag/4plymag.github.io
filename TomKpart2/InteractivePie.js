...
var year = 0;
var data =
    d3.csv("data/tomobs.csv", function(loadedData) {
        ...
        document.getElementById("2009").addEventListener("click", function() {
            ...
            drawPie(2009);
            setWhite();
            document.getElementById("2009").style.backgroundColor = "#B8D4F3";
        });
        ...
        document.getElementById("2010").addEventListener("click", function() {
            ...
            drawPie(2010);
            setWhite();
            document.getElementById("2010").style.backgroundColor = "#B8D4F3";
        });
        ...
        document.getElementById("2012").addEventListener("click", function() {
            ...
            drawPie(2012);
            setWhite();
            document.getElementById("2012").style.backgroundColor = "#B8D4F3";
        });
        ...
        function setWhite() {
            document.getElementById("2009").style.backgroundColor = "white";
            document.getElementById("2010").style.backgroundColor = "white";
            document.getElementById("2012").style.backgroundColor = "white";
...
function drawPie(newYear) {
    ...
    function enterPopup(d, pathEl, x, y) {
        ...
        var yearProperties = {
            2009: { obs: 'obs09', det: 'det09' },
            2010: { obs: 'obs10', det: 'det10' },
            2012: { obs: 'obs12', det: 'det12' },
